...
=TODO= This should automatically be done by systemd services by now..
...
#+end_src
* Rust Development on Leah

For Rust development at Proxmox, I need the Debian-based toolchain installed.
I cannot use rustup from nixpkgs.

For dev projects I can run the following to install dev dependencies

#+begin_src bash :noeval
sudo mk-build-deps -ir
#+end_src

Installing some global dependencies for my dev environment.
...
[[https://support.brave.com/hc/en-us/articles/360039248271-Group-Policy][Brave Docu]]
